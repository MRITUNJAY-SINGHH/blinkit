...
const s = StyleSheet.create({
  bg: { flex: 1, backgroundColor: AppColors.primaryGreen, alignItems: 'center', justifyContent: 'center' },
  center: { alignItems: 'center' },
  emoji: { fontSize: 72, marginBottom: 16 },
  logo: { fontSize: 36, fontWeight: '800', color: AppColors.white, letterSpacing: 1, fontFamily: FontFamily.heading },
  tag: { fontSize: 16, color: 'rgba(255,255,255,0.8)', marginTop: 12, fontFamily: FontFamily.bodyMedium },
});
